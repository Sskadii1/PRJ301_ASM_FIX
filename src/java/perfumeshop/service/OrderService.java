...
public class OrderService {
    ...
    private void updateWalletBalance(User user, double amount) {
        try {
            walletDAO.decuctionMoney(user.getUserName(), amount);
    ...
    public Order getOrderById(int orderId) {
        ...
        try {
            // Note: This would require a new DAO method - for now return null
            // In a complete implementation, you'd add getOrderById to OrderDAO
            LOGGER.log(Level.WARNING, "getOrderById not implemented in DAO layer");
            return null;
        } catch (Exception e) {
